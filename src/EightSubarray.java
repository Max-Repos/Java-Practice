...
public class EightSubarray {
    ...
    public static void main(String[] args){
        ...
        // Create a prefix xor-sum array such that xorArr[i] has value equal to XOR of all elements in arr[0 ..... i]
        ...
        for (int i = 0; i < n; i++) {
            ...
            // If above XOR exists in map, then there is another previous prefix with same XOR, i.e., there is a subarray ending at i with XOR equal to m.
            ans = ans
